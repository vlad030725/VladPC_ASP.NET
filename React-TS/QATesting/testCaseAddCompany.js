...
async function testCaseAddCompany() {
    ...
    await page.waitForSelector('li[style*="opacity: 1;"][style*="order: 3;"]');
    const listItem = await page.$('li[style*="opacity: 1;"][style*="order: 3;"]');
    ...
    const inputSelector = 'input[name="nameCompany"]';
